	...
	<html lang="es">
		...
		<body>
			<div class="form-column col-md-12 col-sm-12 col-xs-12 col-lg-12">
				<center><h3 class="form-group">Impresion de Factura</label></h3>
			</div>
			...
			<div class="modal fade" id="AnularFacturaFormModal" tabindex="-1" role="dialog" aria-labelledby="AnularFacturaFormModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<form action="<?php echo site_url("ImpresionFactura/printFactura")?>" method="post" target="_blank" id="AnularFacturaForm" name="AnularFacturaForm">
							<div class="modal-body">
								<div class="row">
									...
									<div class="form-column col-md-12 col-sm-12 col-xs-12 col-lg-12">
										<div class="form-group">
											<label for="cliente" class="control-label">Correlativo Asignado</label>
											<input type="text" class="form-control" readonly id="corr" name="corr">
										</div>
									</div>
									<div class="clearfix"></div>
									<div class="form-column col-md-6">
							...
							<div class="modal-footer">
								...
								<input class='btn btn-danger btnNuevoFacturaSujetoExcluido' type="submit" value="Imprimir" id="btnNuevoFacturaSujetoExcluido">
							</div>
						</form>
					</div>
				</div>
