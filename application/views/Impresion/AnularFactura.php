	...
	<html lang="es">
		...
		<body>
			<div class="form-column col-md-12 col-sm-12 col-xs-12 col-lg-12">
				<center><h3 class="form-group">Anulación de Correlativos</label></h3>
			</div>
					...
					<div class="row">
						...
						<div class="form-column col-md-12 col-sm-12 col-xs-12 col-lg-12">
							<div class="form-inline">
								<a class="navbar-brand">N° Correlativo</a>
			...
			<div class="modal fade" id="AnularFacturaFormModal" tabindex="-1" role="dialog" aria-labelledby="AnularFacturaFormModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="AnularFacturaFormModalLabel">Anulación de Correlativo</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								<span aria-hidden="true">&times;</span>
							</button>
						</div>
						<form action="<?php echo site_url("DocumentoGenerado/printFactura")?>" method="post" target="_blank" id="AnularFacturaForm" name="AnularFacturaForm">
								...
								<div class="row">
									...
									<div class="form-column col-md-12 col-sm-12 col-xs-12 col-lg-12">
										<div class="form-group">
											...
											<input type="date" id="fechaSujeto" name="fechaSujeto" value="" class="form-control" readonly>
										</div>
									</div>
									<div class="clearfix"></div>
									<div class="form-column col-md-12 col-sm-12 col-xs-12 col-lg-12">
										<div class="form-group">
											...
											<textarea class="form-control" id="Detalle" name="Detalle" readonly></textarea>
										</div>
									</div>
									<div class="clearfix"></div>
									<div class="form-column col-md-12 col-sm-12 col-xs-12 col-lg-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" onclick="return Aviso()" readonly id="corrAnula" name="corrAnula">
										</div>
									</div>
									<div class="clearfix"></div>
									<div class="form-column col-md-12 col-sm-12 col-xs-12 col-lg-12">
										<div class="form-group">
											<label for="cliente" class="control-label">Motivo de Anulación</label>
									...
									<div class="form-column col-md-6">
										<div class="form-group">
											...
											<input type="text" id="Tipo" name="Tipo" class="form-control" onkeypress="return validarNumeros(event)" readonly>
										</div>
									</div>
									<div class="clearfix"></div>
									<div class="form-column col-md-6">
							...
							<div class="modal-footer">
								...
								<input class='btn btn-danger btnNuevoFacturaSujetoExcluido' type="submit" value="Anular" id="btnNuevoFacturaSujetoExcluido">
							</div>
						</form>
					</div>
				</div>
